...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const CharacterVector& >::type variable_names(variable_namesSEXP);
    Rcpp::traits::input_parameter< int >::type verbose(verboseSEXP);
    rcpp_result_gen = Rcpp::wrap(sdr_fit(x, y, coords, bw, adaptive, kernel, intercept, hatmatrix, parallel_type, parallel_arg, optim_bw, optim_bw_criterion, optim_threashold, optim_step, optim_max_iter, select_model, select_model_threshold, variable_names, verbose));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_GWmodel3_sdr_fit", (DL_FUNC) &_GWmodel3_sdr_fit, 19},
    {NULL, NULL, 0}
};
