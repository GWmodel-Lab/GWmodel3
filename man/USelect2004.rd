...
\alias{USelect2004}
\docType{data}
\title{Results of the 2004 US presidential election at the county level (sf)}
\description{
...
\usage{data(USelect2004)}
\format{
  A sf with 3111 electoral divisions on the following 6 variables.
  \describe{
