...
gtdr_fit <- function(x, y, coords, bw, adaptive, kernel, kernel_params, intercept, hatmatrix, parallel_type, parallel_arg, optim_bw, optim_bw_criterion, optim_threashold, optim_step, optim_max_iter, select_model, select_model_threshold, variable_names, verbose) {
    .Call(`_GWmodel3_gtdr_fit`, x, y, coords, bw, adaptive, kernel, kernel_params, intercept, hatmatrix, parallel_type, parallel_arg, optim_bw, optim_bw_criterion, optim_threashold, optim_step, optim_max_iter, select_model, select_model_threshold, variable_names, verbose)
}
