...
gwr_lcr_fit <- function(x, y, coords, bw, adaptive, kernel, longlat, p, theta, intercept, hatmatrix, parallel_type, parallel_arg, optim_bw) {
    .Call(`_GWmodel3_gwr_lcr_fit`, x, y, coords, bw, adaptive, kernel, longlat, p, theta, intercept, hatmatrix, parallel_type, parallel_arg, optim_bw)
}
